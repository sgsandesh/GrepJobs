...
public class Token extends Model {
     ...
     */
    private static Token getNewToken(Usr user, TypeToken type, String email) {
     ...
     */
    public static void sendMailResetPassword(Usr user) throws MalformedURLException {
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    public static void sendMailChangeMail(Usr user, @Nullable String email) throws MalformedURLException {
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    private static void sendMail(Usr user, TypeToken type, String email) throws MalformedURLException {
